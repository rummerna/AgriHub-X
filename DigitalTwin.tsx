...
const DigitalTwin = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-6 space-y-6">
      ...
      <p className="text-xs text-amber-600 text-center">⚠️ Weather data is currently simulated for MVP. Yield projections are estimates only — do not use for critical farm decisions until live data is connected.</p>
    </div>
  );
};
